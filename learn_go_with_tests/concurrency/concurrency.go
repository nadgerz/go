...
var CheckWebsites = CheckWebsites_004

func CheckWebsites_000(wc WebsiteChecker, urls []string) map[string]bool {
...
func CheckWebsites_004(wc WebsiteChecker, urls []string) map[string]bool {
	results := make(map[string]bool)
